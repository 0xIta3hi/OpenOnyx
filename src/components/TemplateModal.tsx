...
function processTemplateVariables(content: string, noteName?: string): string {
  ...
  const variables: Record<string, string> = {
    ...
    '{{date:MMMM D, YYYY}}': now.toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' }),
...
export function TemplateModal({ onClose, onInsert, currentNoteName }: TemplateModalProps) {
      ...
      <div className="template-modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="template-list">
            {loading ? (
              ...
              <div className="template-empty">
                ...
                <small>Create a "Templates" folder in your vault and add .md files.</small>
              </div>
            ) : (
        ...
        <div className="template-modal-footer">
          <div className="template-variables-hint">
            <strong>Variables:</strong> {'{{date}}'}, {'{{time}}'}, {'{{title}}'}, {'{{day}}'}, {'{{timestamp}}'}
          </div>
